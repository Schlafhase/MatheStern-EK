...
\newcommand{\TODO}{
	
	{
		...
		\fbox{\begin{minipage}{\textwidth}
				\textbf{Hinweis} \\
				An dieser Stelle fehlt (im Moment) etwas. Falls Sie helfen möchten dieses Dokument zu vervollständigen, können Sie dies auf \href{https://github.com/Schlafhase/MatheStern-EK/}{GitHub} tun.
		\end{minipage}}
	}
...
\begin{document}
	...
	\begin{defn}[Stetigkeit über Folgen]
		...
		\begin{aleq*}
			&\forall n \colon a_n \in A \\
			\land &\lim_{n \to \infty} a_n = x_0
		\end{aleq*}
