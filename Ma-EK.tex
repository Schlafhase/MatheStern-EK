	...
	\begin{thm}[Grenzwertsätze]
		...
		\begin{proof}
			...
			\begin{enumerate}
				...
				\item
				Weil die Folge \((a_n)\) konvergent ist, ist sie laut \hyperref[konvergentBeschraenkt]{Satz \ref{konvergentBeschraenkt}} auch beschränkt. Es existiert also eine obere Schranke \(s \in \mathbb{R^+}\), für die also gilt \(\forall n \in \mathbb{N} \colon |a_n| \leq s\).
